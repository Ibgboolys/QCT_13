...
\textbf{Pro praktické výpočty} v~této monografii používáme parametr $\alpha$ jako \textbf{fenomenologickou konstantu} kalibrovanou k~experimentům Eöt-Wash: $\alpha_{\text{phenom}} \approx -9 \times 10^{11}$. Mikroskopický vztah $\alpha_{\text{micro}} \sim -E_{\text{pair}}/(m_\nu n_\nu V_{\text{proj}})$ slouží k~\emph{kvalitativnímu pochopení} řádu velikosti, nikoliv k~přesné predikci.
