...
This script simulates the early universe (z ~ 10^7) where W bosons attempt
to decay into baryons + neutrinos. Due to high neutrino density and Fermi
blocking (Pauli exclusion), most decays are suppressed.

Goal: Demonstrate that the suppression factor epsilon_B ~ 10^-8 arises
naturally from phase space filling.
...
plt.tight_layout()
plt.savefig('/home/user/QCT_9/simulations_new/fermi_dirac_initial.png', dpi=150)
...
plt.tight_layout()
plt.savefig('/home/user/QCT_9/simulations_new/epsilon_B_vs_mu.png', dpi=150)
